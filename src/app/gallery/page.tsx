...
const GALLERY_IMAGES = [
  { src: '/images/gallery/jenny-gallery-1.jpg', alt: 'Lash extension gallery photo 1', aspect: 'portrait' },
  { src: '/images/gallery/jenny-gallery-2.jpg', alt: 'Lash extension gallery photo 2', aspect: 'portrait' },
]
